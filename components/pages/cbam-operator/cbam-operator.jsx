...
<div className="row">
            <div className="col-xl-12">
              <h2 className="text-center mb-5">ARTEM Integrated solution support:</h2>
			  <p>
			  Collect Emission Data onsite with our own Micro Flow NDIR Sensor technology to improve accuracy in assessing industrial emission data and minimise your importer's CBAM liability.
			  </p>
            </div>
          </div>
...
<p><strong>Estimation of Emissions</strong></p>
<p>
Multiply activity data (eg fuel, electricity) by appropriate emission factor using default value based on unfavourable assumption</p>
</div>
...
<p><strong>Knowledge of Emissions</strong></p>
<p>
Monitor GHD Concentration and flow rate by filters and/or sensors resulting in precise measurements based on actual emissions</p>
</div>
...
<div className="row">
            <div className="col-xl-12">
              <h2 className="text-center mb-5">Emission Data Collection Based on Calculation Method</h2>
...
<p>Equipment List based on specific Production Route/Production Methodology</p>
</div>
</div>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-5 col-md-6 rounded border m-4 d-flex justify-content-between flex-column">
              ...
              <strong>CBAM Compliance tool</strong></p>
                <p>
                Fully compliant with all legislative requirements, and allows you to easily automate compliance obligations such as compiling your Monitoring Methodology
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-5 col-md-6 rounded border m-4 d-flex justify-content-between flex-column">
              <div className="col-xl-12 p-4">
                ...
                <p>
                Lower carbon price due to emission calculation based on CEMS in contrast to using default values
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-5 col-md-6 rounded border m-4 d-flex justify-content-between flex-column">
              <div className="col-xl-12 p-4">
              <p className="d-flex align-items-center"><img src={tick.src} alt="icon" style={{ width: "32px", height: "32px" }} />
              <strong>Bespoke</strong></p>
                <p>
                Model ARTEM Clause for better CBAM adjusted contracting
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-5 col-md-6 rounded border m-4 d-flex justify-content-between flex-column">
              <div className="col-xl-12 p-4">
              <p className="d-flex align-items-center"><img src={tick.src} alt="icon" style={{ width: "32px", height: "32px" }} />
              <strong>Cost effective</strong></p>
                <p>
                Lower carbon price due to emission calculation based on CEMS in contrast to using default values
                </p>
              </div>
    ...
    <div className="row d-flex align-items-stretch">
      ...
      <div className="col-lg-8 col-md-6">
        <div className="p-4 rounded border d-flex flex-column h-100">
          ...
          <Link href="/contact" className="btn-five">Learn More</Link>
        </div>
      </div>
