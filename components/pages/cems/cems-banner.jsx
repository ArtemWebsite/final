    ...
    <>
      <div className={styles.banner__one}>
        <Swiper modules={[EffectFade, Autoplay, Navigation]} {...slideControl}>
          <SwiperSlide>
            <div
              className={styles.banner__one_image_1}
              style={{
                display: "flex",
                alignItems: "center",
                height: "85vh",
                ...
                <div className="row d-flex align-items-stretch">
                  <div className="col-xl-12 pt-60 pb-10 text-center">
                    <div className={styles.banner__one_content}>
                      ...
                      <h6 className="text-light pb-30  width-narrow">
                        The ARTEM CEMS Modul is designed to continuously monitor
                        multiple parameters, including the content of CO2 SO2,
                        NO, O2 and Perfluoro carbons. It measures:{" "}
                      </h6>
                    </div>
                  </div>
                  <div className="width-narrow-new row ">
                    <div className="col-lg-3 col-md-6 text-center ">
                      <div className="btn-four">Flow Rate</div>
                    </div>

                    <div className="col-lg-3 col-md-6 text-center">
                      <div className="btn-four">Pressure</div>
                    </div>

                    <div className="col-lg-3 col-md-6 text-center">
                      <div className="btn-four">Humidity of the Flue Gas</div>
                    </div>

                    <div className="col-lg-3 col-md-6 text-center">
                      <div className="btn-four">Temperature</div>
                    </div>
                  </div>
                  <div className="col-xl-12 pt-0 text-center">
                    <div className={styles.banner__one_content}>
                      <p>
                        The measured parameters are transmitted to the Data
                        Storage System(DSS).{" "}
                      </p>
                    </div>
                  </div>
