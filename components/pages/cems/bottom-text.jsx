      ...
      <div className="row">
            <div className="col-lg-6 col-md-6">
			  ...
			  <p>UV Differential Optical Absorption Spectroscopy</p>
                <p>The ultraviolet light emitted by the light source converges into the optical fiber and is transmitted to the gas chamber through the optical fiber. 
After passing through the gas chamber, it is absorbed by the the measured gas and transmitted to the spectrometer through the optical fiber. Inside the spectrometer, the light is split by a grating, after which the light signal is converted into an electrical signal by an array sensor to obtain continuous absorption spectrum of the gas. By virtue of Differential Optical Absorption Spectroscopy (DOAS) method, the concentration of the measured gas can be obtained based on this spectral information. </p>
            ...
            <div className="col-lg-6 col-md-6">
              <div className="p-4 rounded border d-flex justify-content-between flex-column col-xl-12">
			  <p>NDIR + GFC + CELL  </p>
                <p>When infrared radiation interacts with gas molecules, infrared light is absorbed by the gas molecules at a particular wavelength, causing vibration of the gas molecules. NDIR (Non-Dispersive Infrared) gas sensors detect decrease in transmitted infrared light which is in proportion to gas concentration. </p>
