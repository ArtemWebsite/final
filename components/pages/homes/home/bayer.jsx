...
const Bayer = () => {
    ...
    return (
        <div className="team__details">
            <div className="col-xl-12 text-center"><div className="mb-5"><h2 className="mb-5">Alumina Production <span className="color-green-artm">Bayer</span> Process</h2></div></div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="contact__form-area mt-40 rounded bg-light-green-artm mb-100">
                    ...
                    <div className="container my-5">
                        ...
                        <div className="row mb-5">
							...
							<h2 className="text-center">Working Principles Measurement Method</h2>
                                <h6 className="mb-4">FTIR Spectroscopy</h6>
                                <p>
